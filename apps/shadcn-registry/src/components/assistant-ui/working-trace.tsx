...
export const WorkingTrace: FC<{
  ...
  // above. Its children carry real client-clock spans; report those instead of
  // dropping the duration. Never `Date.now()` here — that would grow with the
  // age of reloaded history rather than measuring the run.
