...
Use a Radix-based shadcn project. For a new project, initialize it before adding
Aomi components:
...
These Radix-based UI primitives are installed from Aomi's registry so their APIs
match the widget components.
